...
* **MigraGuide** — Платформа помощи трудовым мигрантам (юридическая информация, вакансии).
  * *Стек:* Django, DRF, PostgreSQL, Docker, Celery, RabbitMQ.
* **Digital Med** — Онлайн-система записи к врачам и ведения медицинских карт.
